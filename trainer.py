...
def parse_args(args=None):
    ...
    parser.add_argument("--process_group", type=str,
                        help="process_group 'nccl for linux or 'gloo' for windows")
...
def override_params(params, args):
    ...
    params.process_group=args.process_group or params.process_group
...
def main(args):
    ...
    if args.distributed:
        dist.init_process_group(params.process_group)
        torch.cuda.set_device(args.local_rank)
        torch.set_default_tensor_type(torch.cuda.FloatTensor)
    else:
        dist.init_process_group(params.process_group, init_method=args.url,
